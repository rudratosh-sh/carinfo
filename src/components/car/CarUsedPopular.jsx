...
const CarUsedPoplular = () => {
    return (
        <section className="theme-block services inner-block">
            <hgroup>
                <h2 className="theme_hd">Popular used Cars</h2>
            </hgroup>
            <ul className="nav nav-tabs">
                <li className="nav-item">
                    <a className="nav-link active" data-toggle="tab" href="#u1">
                        Under 3.5 Lakh
                    </a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" data-toggle="tab" href="#u2">
                        Under 5 Lakh
                    </a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" data-toggle="tab" href="#u3">
                        Above 5 Lakh
                    </a>
                </li>
            ...
            <div className="tab-content">
                <div id="u1" className="tab-pane active">
                    <br />
                    <div className="owl-carousel owl-theme" id="used1">
                        <div className="item">
                ...
                <div id="u2" className="tab-pane fade">
                    <br />
                    <div className="owl-carousel owl-theme" id="used2">
                        <div className="item">
                            <aside className="caro">
                                <figure>
                                    <img src="img/inner-prd.png" className="img-fluid" />
                ...
                <div id="u3" className="tab-pane fade">
                    <br />
                    <div className="owl-carousel owl-theme" id="used3">
                        <div className="item">
                            <aside className="caro">
                                <figure>
                                    <img src="img/inner-prd.png" className="img-fluid" />
...
export default CarUsedPoplular;