...
const CarBudgetPopular = () => {
    return (
        <section className="theme-block services inner-block">
            <hgroup>
                <h2 className="theme_hd">Popular Cars by Budget</h2>
            </hgroup>
            <ul className="nav nav-tabs">
                <li className="nav-item">
                    <a className="nav-link active" data-toggle="tab" href="#bu1">
                        Under 5 Lakh
                    </a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" data-toggle="tab" href="#bu2">
                        5-10 Lakh
                    </a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" data-toggle="tab" href="#bu3">
                        Above 10 Lakh
                    </a>
                </li>
            ...
            <div className="tab-content">
                <div id="bu1" className="tab-pane active">
                    <br />
                    <div className="owl-carousel owl-theme" id="bc1">
                        <div className="item">
                ...
                <div id="bu2" className="tab-pane fade">
                    <br />
                    <div className="owl-carousel owl-theme" id="bc2">
                        <div className="item">
                            <aside className="caro">
                                <figure>
                                    <img src="img/inner-prd.png" className="img-fluid" />
                ...
                <div id="bu3" className="tab-pane fade">
                    <br />
                    <div className="owl-carousel owl-theme" id="bc3">
                        <div className="item">
                            <aside className="caro">
                                <figure>
                                    <img src="img/inner-prd.png" className="img-fluid" />
...
export default CarBudgetPopular;